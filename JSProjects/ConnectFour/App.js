...
function checkBoard() {
  ...
  [[0, 1, 2, 3], [41, 40, 39, 38], [7, 8, 9, 10],[34, 33, 32, 31],
   ...
   [11, 7, 23, 29],[12, 18, 24, 30], [1, 2, 3, 4], [5, 4, 3, 2], [8, 9, 10, 11],
  ...
  for(let y=0; y<winningArrays.length; y++){
    const sq1=squares[winningArrays[y][0]],sq2=squares[winningArrays[y][1]],
      sq3=squares[winningArrays[y][2]],sq4=squares[winningArrays[y][3]]
    ...
    sq4.classList.contains('player-one')){
      ...
      for(var i=0, len = squares.length; i<len;i++)
      {squares[i].onclick =()=>{alert('game over')};}
    }
